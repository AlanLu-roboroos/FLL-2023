...
class DriveBaseFull:
    def __init__(self, config, Lmotor, Rmotor, gyro, diameter, track, runButton=None, Llight: LightSensor=None, Rlight: LightSensor=None): # type: ignore
    ...
    def lineReset(self, direction=1, timeout=10000):
        ...
        while True:
            ...
            self.LLmotor.run((self.Llight.readLight()-50)*1.7*direction)
            self.RLmotor.run((self.Rlight.readLight()-50)*1.7*direction)
        self.stop()
